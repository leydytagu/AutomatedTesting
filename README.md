...
1. Type credentials in the **Username** field (ensure they are under the "Accepted usernames" section).
...
```
cd existing_repo
git remote add origin https://gitlab.com/frontend904913/final-task.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/frontend904913/final-task/-/settings/integrations)
